...
2 Install PsExec in powershell with a self created ssm document using system manager 
<img width="1766" height="777" alt="image" src="https://github.com/user-attachments/assets/9e13fc24-5f83-4462-80de-1ea89652aa34" />

3 Install git, uv, python packages using uv and git clone github repo in powershell with ssm command parameters using system manager  
git and uv installation     
